            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CommentTime = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9953),
                            Email = "tutb@live.com",
                            Name = "Scott Trinh",
                            PostId = 1
                        },
                        new
                        {
                            ...
                            CommentTime = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9957),
                        ...
                        new
                        {
                            ...
                            CommentTime = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9959),
            ...
            modelBuilder.Entity("FA.JustBlog.Core.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            Meta = "EF, MVC",
                            Modified = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9664),
                            PostContent = "In the above example, the Course and Teacher entities have two one-to-many relationships...",
                            PostedOn = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9679),
                            Published = true,
                            RateCount = 10,
                        ...
                        new
                        {
                            ...
                            PostedOn = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9686),
                            Published = true,
                        ...
                        new
                        {
                            ...
                            Meta = "C#, .NET",
                            PostContent = "Content of the post",
                            PostedOn = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9689),
                            Published = true,
                        ...
                        new
                        {
                            ...
                            Meta = "C#, .NET",
                            PostContent = "Content of the post",
                            PostedOn = new DateTime(2024, 8, 6, 22, 7, 57, 776, DateTimeKind.Local).AddTicks(9691),
                            Published = true,
                            ShortDescription = "A look at advanced C# techniques",
                            Title = "Latest Post",
                            UrlSlug = "advanced-c-sharp"
